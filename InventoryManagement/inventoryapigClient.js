...
var inventoryapigClientFactory = {};
inventoryapigClientFactory.newClient = function (config) {
    var apigClient = { };
    if(config === undefined) {
        config = {
            accessKey: '',
    ...
    var invokeUrl = 'https://npc7pfc9uk.execute-api.us-east-1.amazonaws.com/InventoryManagement_InventoryDev';
    ...
    apigClient.inventoryGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['action'], ['body']);
        
        var inventoryGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/inventory').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
    ...
    apigClient.inventoryPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['action'], ['body']);
        
        var inventoryPutRequest = {
        ...
        return apiGatewayClient.makeRequest(inventoryPutRequest, authType, additionalParams, config.apiKey);
    };
