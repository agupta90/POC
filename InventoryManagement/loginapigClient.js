...
var loginapigClientFactory = {};
loginapigClientFactory.newClient = function (config) {
    var apigClient = { };
    if(config === undefined) {
        config = {
            accessKey: '',
    ...
    var invokeUrl = 'https://x6j2hu8x8e.execute-api.us-east-1.amazonaws.com/InventoryManagement_Dev';
